"""
Django settings for sunnybee_client project.
...
INSTALLED_APPS = [
    'tag_metrics.apps.TagMetricsConfig',
...
ROOT_URLCONF = 'sunnybee_client.urls'
...
WSGI_APPLICATION = 'sunnybee_client.wsgi.application'
